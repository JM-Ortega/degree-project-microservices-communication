...
public class AnteproyectoRequest {
    ...
    public AnteproyectoRequest() {} // requerido por Jackson

    public AnteproyectoRequest(String codirector, Departamento departamento, String descripcion,
                               String director, String estudiante1, String estudiante2, String titulo) {
