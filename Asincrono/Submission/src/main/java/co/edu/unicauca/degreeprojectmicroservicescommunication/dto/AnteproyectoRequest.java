...
public class AnteproyectoRequest {
    ...
    public DocenteDTO getDirector() { return director; }
    public void setDirector(DocenteDTO director) { this.director = director; }

    public DocenteDTO getCodirector() { return codirector; }
    public void setCodirector(DocenteDTO codirector) { this.codirector = codirector; }
}
